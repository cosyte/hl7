...
Because provenance is the _sender's claim_ and our hard rule is "never guess,"
...
- The map is a _provenance_ map, not a _versioned codeset_: code-system versions
