 ...
 * was NOT assessed.
 *
 * `undecidedAt` is the pre-rendered STRUCTURAL description of the location(s)
 * the predicate could not be decided at (`RXA-20`, `PID-5 component 1`), which
 * is what an author needs to fix it. Like every other factory here the message
